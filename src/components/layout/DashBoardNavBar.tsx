...
export default function DashBoardNavBar() {
  ...
  const navItems = [
    { name: "Collaborators", href: "/admin/collabaration" },
    {
      ...
      href: "#",
      dropdown: [
        { name: "Research Associates", href: "/admin/people/research" },
        { name: "Students", href: "/admin/people/students" },
        { name: "Administrative Staff", href: "/admin/people/staff" },
      ],
    },
    { name: "Events", href: "/admin/event" },
    { name: "Publication", href: "/admin/publication" },
